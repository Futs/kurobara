...
class ManyToonCOM(Connector):
    def __init__(self):
        super().__init__()
        self.base_url = "https://manytoon.com"
        
    async def get_series_data(self, seriesId):
        series_url = f"{self.base_url}/comic/{seriesId}"
    ...
    async def get_chapter_data(self, seriesId, chapterId):
        chapter_url = f"{self.base_url}/comic/{seriesId}/{chapterId}"
