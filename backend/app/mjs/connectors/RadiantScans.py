...
class RadiantScans(Connector):
    def __init__(self):
        super().__init__()
        self.base_url = "https://radiantscans.com"
    ...
    async def get_series_data(self, seriesId):
        ...
        title_element = document.select_one(".series-title h1")
        if not title_element:
            return None
            
        title = title_element.text.strip()
        cover_element = document.select_one(".comic-cover img")
        ...
        for chapter_element in chapter_elements:
            ...
            chapter_id = link.get("href").split("/")[-1]
    ...
    async def get_chapter_data(self, seriesId, chapterId):
        ...
        image_elements = document.select(".chapter-container img.page-img")
        images = []
