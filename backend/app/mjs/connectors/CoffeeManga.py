...
class CoffeeManga(Connector):
    def __init__(self):
        super().__init__()
        self.base_url = "https://coffeemanga.io"
    ...
    async def get_series_data(self, seriesId):
        ...
        chapters = []
        chapter_list = document.select("li.wp-manga-chapter")
        
        for chapter_element in reversed(chapter_list):
