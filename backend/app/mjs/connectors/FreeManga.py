...
class FreeManga(Connector):
    def __init__(self):
        super().__init__()
        self.base_url = "https://freemanga.me"
    ...
    async def get_series_data(self, seriesId):
        ...
        chapters = []
        chapter_elements = document.select("#chapterlist li")
    ...
    async def get_chapter_data(self, seriesId, chapterId):
        ...
        image_elements = document.select("#mangacontainer img")
        images = []
